...
namespace YazdNegar.Forms.YazdNegarManager
{
    partial class YazdNegarForm
    {
        ...
        private void InitializeComponent(bool initialize)
        {
			...
			this.YazdNegarControl = new YazdNegar.Forms.YazdNegarManager.YazdNegarControl(initialize);
			this.SuspendLayout();
			// 
			// timerOpenAnimation
			// 
			...
			this.elementHost1.Child = this.YazdNegarControl;
			// 
			// YazdNegarForm
			// 
		...
		private YazdNegarControl YazdNegarControl;
	}
}