...
using YazdNegar.Forms.YazdNegarManager.DocumentManager;
using YazdNegar.Forms.YazdNegarManager.DocumentManager.Models;
...
{
    public partial class YazdNegarControl : System.Windows.Controls.UserControl, Interfaces.ICloseForm
    {
        public Action CloseForm { get; set; }

        string updateLink = "";

        public YazdNegarControl(bool initialize)
        {
