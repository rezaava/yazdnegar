    ...
    public partial class CreateDocumentSlide2 : UserControl
    {
        ...
        private void BtnGoToWebsite_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    FileName = "https://YazdNegar.ir", // آدرس سایت خودتون رو بذارید
        ...
        private async void btnStore_Click(object sender, RoutedEventArgs e)
        {
            ...
            //    // اگر نام پروژه YazdNegar است و فایل در پوشه Templates است:
            //    // resourceName = "YazdNegar.Templates.Blank.docx";
            ...
            //        {
            //            var documentVM = dc.CurrentView as YazdNegar.Forms.YazdNegarManager.DocumentManager.ViewModel.DocumentsVM;
            //            if (documentVM != null)
            //            {
