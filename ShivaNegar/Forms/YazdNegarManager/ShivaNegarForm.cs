...
namespace YazdNegar.Forms.YazdNegarManager
{

    public partial class YazdNegarForm : Form
    {
        [Flags]
        ...
        public YazdNegarForm(bool initialize)
        {
            ...
            if (initialize)
            {
                ...
                YazdNegarControl.createDocument.CloseFormRequest += () =>//CloseFormButton Event
                {
                    closeForm();
                };
                YazdNegarControl.createDocument.AlwaysOnTopEnableRequest += () =>
                {
                    this.TopMost = true;
                };
                YazdNegarControl.createDocument.AlwaysOnTopDisableRequest += () =>
                {
                    this.TopMost = false;
                };
                YazdNegarControl.createDocument.MaximizeStateFormRequest += () =>
                {
                ...
                YazdNegarControl.createDocument.MinimizeStateFormRequest += () =>
                {
                ...
                YazdNegarControl.networkingManagerControl.CloseFormRequest += () =>//CloseFormButton Event
                {
                    closeForm();
                };
                YazdNegarControl.networkingManagerControl.AlwaysOnTopEnableRequest += () =>
                {
                    this.TopMost = true;
                };
                YazdNegarControl.networkingManagerControl.AlwaysOnTopDisableRequest += () =>
                {
                    this.TopMost = false;
                };
                YazdNegarControl.networkingManagerControl.MaximizeStateFormRequest += () =>
                {
                    if (WindowState != FormWindowState.Maximized)
                        WindowState = FormWindowState.Maximized;
                    else
                ...
                YazdNegarControl.networkingManagerControl.MinimizeStateFormRequest += () =>
                {
                    if (WindowState != FormWindowState.Minimized)
                        WindowState = FormWindowState.Minimized;
                    else
                ...
                YazdNegarControl.CloseForm += () =>//CloseFormButton Event
                {
                    closeForm();
                };
                YazdNegarControl.documentManager.CloseForm += () =>//CloseFormButton Event
                {
                    closeForm();
                };
                if (YazdNegarControl.documentManager.DataContext is NavigationVM dc)//CloseFormRequest from Pages
                {
                ...
                YazdNegarControl.MouseDown += YazdNegarControl_MouseDown;
            }
        }
        ...
        private void YazdNegarControl_MouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            releaseCapture();
        ...
        public YazdNegarControl GetMainControl()
        {
            return YazdNegarControl;
        }


        public void ShowArchiveDocuments()
        {
            if (YazdNegarControl != null)
            {
                YazdNegarControl.ShowDocumentManagerWithArchive();
            }
        }
