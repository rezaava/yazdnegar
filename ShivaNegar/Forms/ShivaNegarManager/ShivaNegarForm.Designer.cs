...
namespace ShivaNegar.Forms.ShivaNegarManager
{
    partial class ShivaNegarForm
    {
        ...
        private void InitializeComponent(bool initialize)
        {
			...
			this.shivaNegarControl = new ShivaNegar.Forms.ShivaNegarManager.ShivaNegarControl(initialize);
			this.SuspendLayout();
			// 
			// timerOpenAnimation
			// 
		...
		private ShivaNegarControl shivaNegarControl;
	}
}